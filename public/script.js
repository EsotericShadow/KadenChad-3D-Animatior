...
class PortfolioScene {
    ...
    handleWheel(e) {
        ...
        if (this.zoomZ < -5000) {
            this.zoomZ = -500; // Reset to logo position
            this.targetZoomZ = -500;
        } else {
    ...
    createContentFrames() {
        ...
        frameConfigs.forEach((config, index) => {
            ...
            if (index === 0) {
                ...
                div.innerHTML = `<img src="assets/Logo.png" alt="Kaden Chad Logo" class="logo-img">`;
            } else {
                // Other frames
                div.className = 'frame';
                ...
                if (index === 1) {
                    ...
                    div.innerHTML = `
                        ...
                        <div class="video-container">
                            <img src="assets/BannerText.png" alt="Animation Reel" style="width: 100%; height: auto;">
                        </div>
