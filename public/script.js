...
class PortfolioScene {
    ...
    createContentFrames() {
        ...
        frameConfigs.forEach((config, index) => {
            // Create HTML content for each frame
            const div = document.createElement('div');
            
            if (index === 0) {
                // Logo frame - using Character.png instead of Logo.png as requested
                div.className = 'raw-logo';
                div.innerHTML = `<img src="assets/Character.png" alt="Kaden Chad Logo" class="logo-img">`;
            } else {
                // Other frames
                div.className = 'frame';
                
                if (index === 1) {
                    // Home frame - using full name "Kaden Chad" instead of just "Chad"
                    div.innerHTML = `
                        <h1>KADEN CHAD</h1>
                    ...
                    // Reel frame - using video instead of image
                    div.innerHTML = `
                        ...
                        <p>Showcasing a variety of character animations from personal projects and client work. Each piece demonstrates my approach to bringing characters to life through movement and emotion.</p>
                    `;
                } else if (index === 4) {
                    // Contact frame
                    div.innerHTML = `
            ...
            // Create 3D mesh for positioning
            const img = new Image();
            if (index === 0) {
                img.src = 'assets/Character.png'; // Changed from Logo.png to Character.png
            } else if (index === 1) {
                img.src = 'assets/Character.png';
            } else {
                img.src = 'assets/blank.txt';
            }
    ...
    updateParticles() {
        if (!this.particleSystem || !this.particleSystem.geometry.attributes.position) return;
    ...
    animate() {
        ...
        if (this.spotLight) this.spotLight.position.z = this.camera.position.z;
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing portfolio scene...');
